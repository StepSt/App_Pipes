...
public class FragmentBuy extends Fragment implements Main.OnBackPressedListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //region Sent
        final LinearLayout delivery =(LinearLayout) v.findViewById(R.id.Delivery);
                    ...
                    for (Product p : boxAdapter.getBox()) {
                        if (p.box)
                            switch (p.type_pipes){
                                ...
                                case "Труба НКТ":
                                    message_string += "- Тип: " + p.type_pipes + " Диаметр наружный: " + p.D + " Толщина стенки: " + p.S + " Длинна: " + p.L + " Масса: " + p.M + "\n";
                                    break;
                                case "Штанга":
